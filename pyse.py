...
class Pyse(object):
    ...
    def __init__(self, browser='ff',driversrc=None):
        '''
    ...
    def get_element(self,css):
        ...
        if by == "id":
            ...
            raise NameError("Please enter the correct targeting elements,'id','name','class','link_text','xpath','css'.")
        self.js("arguments[0].setAttribute('style', arguments[1]);", element,"background: yellow; border: 2px solid red;")
        return element
    ...
    def js(self, script,element=None,style=None):
        '''
        Execute JavaScript scripts.
        Usage:
        driver.js("window.scrollTo(200,1000);")
        '''
        self.driver.execute_script(script,element,style)
